...
class ConstructorResolver {
            ...
            for (Constructor<?> candidate : candidates) {
                ...
                if (resolvedValues != null) {
                    try {
                        ...
                        argsHolder = this.createArgumentArray(beanName, mbd, resolvedValues, bw, paramTypes, paramNames,
                                this.getUserDeclaredConstructor(candidate), autowiring, candidates.length == 1);
    ...
    public BeanWrapper instantiateUsingFactoryMethod(
        ...
        // 创建并初始化 BeanWrapper 对象，用于封装将要创建的 bean 实例
        BeanWrapperImpl bw = new BeanWrapperImpl();
        this.beanFactory.initBeanWrapper(bw);

        Object factoryBean; // 工厂 bean
        Class<?> factoryClass; // 工厂 bean 对应的 Class 对象
        boolean isStatic; // 是否是静态工厂

        // 获取工厂 bean 名称
        String factoryBeanName = mbd.getFactoryBeanName();
        /*
         * 存在 factory-bean，说明是非静态工厂
         *
         * <bean id="my-bean-simple-factory" class="org.zhenchao.spring.ioc.factory.MyBeanSimpleFactory"/>
         ...
         *
         * <bean id="my-bean-2" class="org.zhenchao.spring.ioc.factory.MyBeanStaticFactory" factory-method="create"/>
         */
        else {
            if (!mbd.hasBeanClass()) {
                throw new BeanDefinitionStoreException(mbd.getResourceDescription(), beanName,
        ...
        if (factoryMethodToUse == null || argsToUse == null) {
            ...
            // 存在多个候选工厂方法，执行排序，让 public 在前，参数多的在前
            ...
            // getBean 时未指定构造参数，尝试从 BeanDefinition 实例中解析
            else {
                ...
                if (parameterCount >= minNrOfArgs) {
                    ...
                    if (explicitArgs != null) {
                        ...
                        try {
                            ...
                            // 依据参数名称和类型创建 ArgumentsHolder 对象
            ...
            if (factoryMethodToUse == null || argsToUse == null) {
                ...
                throw new BeanCreationException(mbd.getResourceDescription(), beanName,
                        "Invalid factory method '" + mbd.getFactoryMethodName() + "': needs to have a non-void return type!");
    ...
    /**
     * 基于反射机制调用工厂 bean 的指定方法依据给定的参数进行实例化
     *
     * @param beanName
     * @param mbd
     * @param factoryBean
    ...
    private ArgumentsHolder createArgumentArray(
        ...
        for (int paramIndex = 0; paramIndex < paramTypes.length; paramIndex++) {
            ...
            if (valueHolder != null) {
                ...
                try {
                    Object autowiredArgument = this.resolveAutowiredArgument(
    ...
    private Object[] resolvePreparedArguments(String beanName, RootBeanDefinition mbd, BeanWrapper bw,
        ...
        for (int argIndex = 0; argIndex < argsToResolve.length; argIndex++) {
            ...
            if (argValue == autowiredArgumentMarker) {
                argValue = this.resolveAutowiredArgument(methodParam, beanName, null, converter, fallback);
