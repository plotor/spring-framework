...
public class JpaTransactionManager extends AbstractPlatformTransactionManager
    ...
    protected Object doGetTransaction() {
        ...
        EntityManagerHolder emHolder = (EntityManagerHolder)
                TransactionSynchronizationManager.getResource(this.obtainEntityManagerFactory());
        if (emHolder != null) {
        ...
        if (this.getDataSource() != null) {
            ConnectionHolder conHolder = (ConnectionHolder)
                    TransactionSynchronizationManager.getResource(this.getDataSource());
    ...
    protected void doBegin(Object transaction, TransactionDefinition definition) {
        ...
        try {
            ...
            Object transactionData = this.getJpaDialect().beginTransaction(em,
                ...
                if (conHandle != null) {
                    ...
                    if (logger.isDebugEnabled()) {
                        logger.debug("Not exposing JPA transaction [" + em + "] as JDBC transaction because " +
                                "JpaDialect [" + this.getJpaDialect() + "] does not support JDBC Connection retrieval");
                    }
                }
            }
            ...
            if (txObject.isNewEntityManagerHolder()) {
                TransactionSynchronizationManager.bindResource(
                        this.obtainEntityManagerFactory(), txObject.getEntityManagerHolder());
            }
    ...
    protected void doResume(@Nullable Object transaction, Object suspendedResources) {
        ...
        TransactionSynchronizationManager.bindResource(
                this.obtainEntityManagerFactory(), resourcesHolder.getEntityManagerHolder());
    ...
    protected void doCommit(DefaultTransactionStatus status) {
        ...
        try {
            ...
            if (ex.getCause() instanceof RuntimeException) {
                DataAccessException dae = this.getJpaDialect().translateExceptionIfPossible((RuntimeException) ex.getCause());
                if (dae != null) {
                    throw dae;
                }
            }
    ...
    protected void doCleanupAfterCompletion(Object transaction) {
        ...
        if (this.getDataSource() != null && txObject.hasConnectionHolder()) {
            ...
            if (conHandle != null) {
                try {
                    this.getJpaDialect().releaseJdbcConnection(conHandle,
                            txObject.getEntityManagerHolder().getEntityManager());
                } catch (Throwable ex) {
